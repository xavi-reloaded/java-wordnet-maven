...
public class RemoteFileManager extends FileManagerImpl {
	 ...
	 * @exception java.rmi.RemoteException If remote operation failed.
	 */
	 ...
	 * registry.
	 * @exception java.rmi.AlreadyBoundException If <code>BINDING_NAME</code> is already bound.
	 * @exception java.rmi.RemoteException If remote operation failed.
	 */
	 ...
	 * @exception java.rmi.AccessException If this operation is not permitted.
	 * @exception java.rmi.NotBoundException If there is no object named <code>BINDING_NAME</code> in the remote registry.
	 * @exception java.rmi.RemoteException If remote operation failed.
	 * @exception java.rmi.UnknownHostException  If the host could not be located.
	 */
